    ...
    _buildGraphTypePicker() {
        ...
        const categories = [
            ...
            { name: 'Distribution', items: [
                ...
                { value: 'box-points', label: 'Box + Points', icon: '<svg viewBox="0 0 20 16"><rect x="3" y="4" width="5" height="8" rx="0.5" fill="none" stroke="#4a8f32" stroke-width="1.2"/><line x1="5.5" y1="1" x2="5.5" y2="4" stroke="#4a8f32" stroke-width="1"/><line x1="5.5" y1="12" x2="5.5" y2="15" stroke="#4a8f32" stroke-width="1"/><line x1="3" y1="8" x2="8" y2="8" stroke="#4a8f32" stroke-width="1.5"/><circle cx="5" cy="6" r="0.9" fill="#333" opacity="0.5"/><circle cx="6" cy="10" r="0.9" fill="#333" opacity="0.5"/><circle cx="4.5" cy="13" r="0.9" fill="#333" opacity="0.5"/><rect x="12" y="3" width="5" height="9" rx="0.5" fill="none" stroke="#e67e22" stroke-width="1.2"/><line x1="14.5" y1="0.5" x2="14.5" y2="3" stroke="#e67e22" stroke-width="1"/><line x1="14.5" y1="12" x2="14.5" y2="15.5" stroke="#e67e22" stroke-width="1"/><line x1="12" y1="7" x2="17" y2="7" stroke="#e67e22" stroke-width="1.5"/><circle cx="14" cy="5" r="0.9" fill="#333" opacity="0.5"/><circle cx="15" cy="9" r="0.9" fill="#333" opacity="0.5"/></svg>' },
                { value: 'violin-only', label: 'Violin', icon: '<svg viewBox="0 0 20 16"><path d="M5.5 1 C3 4,2 6,2 8 C2 10,3 12,5.5 15 C8 12,9 10,9 8 C9 6,8 4,5.5 1Z" fill="#4a8f32" opacity="0.5" stroke="#4a8f32" stroke-width="0.8"/><line x1="3" y1="8" x2="8" y2="8" stroke="#fff" stroke-width="1.5"/><path d="M14.5 1 C12 4,11 6,11 8 C11 10,12 12,14.5 15 C17 12,18 10,18 8 C18 6,17 4,14.5 1Z" fill="#e67e22" opacity="0.5" stroke="#e67e22" stroke-width="0.8"/><line x1="12" y1="8" x2="17" y2="8" stroke="#fff" stroke-width="1.5"/></svg>' },
                { value: 'violin-plot', label: 'Violin + Points', icon: '<svg viewBox="0 0 20 16"><path d="M5.5 1 C3 4,2 6,2 8 C2 10,3 12,5.5 15 C8 12,9 10,9 8 C9 6,8 4,5.5 1Z" fill="#4a8f32" opacity="0.5" stroke="#4a8f32" stroke-width="0.8"/><circle cx="5" cy="6" r="0.8" fill="#333"/><circle cx="6" cy="9" r="0.8" fill="#333"/><circle cx="5" cy="11" r="0.8" fill="#333"/><path d="M14.5 1 C12 4,11 6,11 8 C11 10,12 12,14.5 15 C17 12,18 10,18 8 C18 6,17 4,14.5 1Z" fill="#e67e22" opacity="0.5" stroke="#e67e22" stroke-width="0.8"/><circle cx="14" cy="5" r="0.8" fill="#333"/><circle cx="15" cy="8" r="0.8" fill="#333"/><circle cx="14" cy="10" r="0.8" fill="#333"/></svg>' },
