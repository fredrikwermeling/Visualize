...
class OncoPrintRenderer {
    constructor(containerId) {
        ...
        this.colorThemes = {
            ...
            earth: ['#8B4513','#A0522D','#6B8E23','#556B2F','#B8860B','#D2691E','#CD853F','#DEB887','#708090','#2F4F4F'],
            ocean: ['#003F5C','#2F4B7C','#665191','#A05195','#D45087','#F95D6A','#FF7C43','#FFA600','#00CED1','#20B2AA'],
