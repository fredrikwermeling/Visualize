...
class DataTable {
    ...
    loadGrowthSampleData() {
        // 3 groups x 6 subjects x 7 timepoints — tumor volume (mm³)
        // Vehicle grows fast, Treatment slows it, High dose arrests growth
        // Wide within-group variance for visible SEM ribbons
        const headers = [
            'Time',
